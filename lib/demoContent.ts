...
export const demoContent = {
  ...
  cta: {
    en: {
      ...
      description:
        "Leave a sample request to show how this could become a real inbound sales form later.",
      ...
      message: "Message",
      submitButton: "Save demo request",
      success: "Demo request saved locally.",
      primaryButton: "Go to patient chat",
      secondaryButton: "View clinic owner dashboard",
      realContactTitle: "Real validation contact",
      realContactBody:
        "Replace these placeholders before sharing the demo publicly.",
      whatsappLink: "Contact by WhatsApp",
      emailLink: "Send email",
      formLink: "Open validation form",
      footnote:
    ...
    es: {
      ...
      description:
        "Deja una solicitud de ejemplo para mostrar cómo esto podría convertirse luego en un formulario real.",
      ...
      message: "Mensaje",
      submitButton: "Guardar solicitud demo",
      success: "Solicitud guardada localmente.",
      primaryButton: "Ir al chat del paciente",
      secondaryButton: "Ver panel del dueño",
      realContactTitle: "Contacto real para validación",
      realContactBody:
        "Reemplaza estos enlaces antes de compartir el demo públicamente.",
      whatsappLink: "Contactar por WhatsApp",
      emailLink: "Enviar email",
      formLink: "Abrir formulario",
      footnote:
